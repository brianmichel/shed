...
| ID | State | Depends On | Task |
|---|---|---|---|
| `SF-020` | `NOT_STARTED` | `SF-010` | Design Postgres schema for existing sandboxes, sessions, commands, events, API tokens, and idempotency keys. |
| `SF-021` | `NOT_STARTED` | `SF-020` | Add migration framework. |
...
| `SF-028` | `NOT_STARTED` | `SF-022` | Add config flags and env vars for Postgres connection and store selection. |
...
| ID | State | Depends On | Task |
|---|---|---|---|
| `SF-040` | `NOT_STARTED` | `SF-032` | Add durable scheduler package for AgentRun progression. |
...
| ID | State | Depends On | Task |
|---|---|---|---|
| `SF-050` | `NOT_STARTED` | `SF-030` | Add `Repository` model. |
| `SF-051` | `NOT_STARTED` | `SF-050` | Add repository API for registering repositories. |
| `SF-052` | `NOT_STARTED` | `SF-050` | Add checkout configuration to WorkItem or AgentRun. |
| `SF-053` | `NOT_STARTED` | `SF-052` | Implement clone and checkout step inside sandbox. |
| `SF-054` | `NOT_STARTED` | `SF-053` | Add branch and worktree preparation. |
