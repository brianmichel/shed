...
Then open `http://127.0.0.1:6464/ui/` and enter `shed-dev-token` when prompted, or use the API under `http://127.0.0.1:6464/v1` with `Authorization: Bearer shed-dev-token`.
